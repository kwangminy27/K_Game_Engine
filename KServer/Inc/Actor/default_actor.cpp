...
K::DefaultActor::DefaultActor(DefaultActor const& _other) : ActorServer(_other)
{
}

K::DefaultActor::DefaultActor(DefaultActor&& _other) noexcept : ActorServer(std::move(_other))
{
}
